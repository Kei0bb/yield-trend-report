...
export default function YieldChart({ processName, productData }: YieldChartProps) {
  ...
  const multiLayout: Partial<Plotly.Layout> = {
    ...
    yaxis: { title: { text: "Fail Bin (%)", font: { size: 11, color: "#787672" } }, side: "left", range: [0, 102], tickfont: { size: 11, color: "#615d59" }, gridcolor: "rgba(0,0,0,0.04)", zerolinecolor: "rgba(0,0,0,0.08)" },
